...
export default function NotFound() {
  return (
    <div className="bg-grid relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-background px-6 text-center">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <p className="mt-4 max-w-md text-base leading-relaxed text-foreground/60">
          The page you&apos;re looking for has been moved, renamed, or never existed. Let&apos;s
          get you back on track.
        </p>
        <Link
          href="/"
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-brand px-7 py-3.5 text-sm font-bold uppercase tracking-wider text-black transition-transform hover:scale-[1.03]"
        >
          Back to Home
